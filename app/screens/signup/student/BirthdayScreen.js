...
const BirthdayScreen = ({route, navigation}) => {
    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>birthday is...</TitleText>
            </View>
...
function handleNextButton(navigation){
    if (!StudentSignupController.getInstance().verifyBirthday(inputDate)){
        Alert.alert("Birthday", "Please enter a valid date");
        return;
    }
