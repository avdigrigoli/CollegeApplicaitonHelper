...
const LastNameScreen = ({route, navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>last name is...</TitleText>
            </View>
            ...
            <View style={{flex: 0.2}}>
                ...
                <Text style={styles.text}> This is how your last name will appear on Urahah</Text>
...
function handleNextButton(navigation){
    if (!StudentSignupController.getInstance().verifyName(inputText, NameType.LAST)){
        Alert.alert("Last Name", "Please do not leave your last name blank");
        return;
    }
