...
const ReenterPasswordScreen = ({route, navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                <TitleText>Re-enter your</TitleText>
...
function handleNextButton(navigation){
    if (!StudentSignupController.getInstance().isPasswordMatch(inputText)){
        Alert.alert("Password Match", "Passwords do not match. Please go back and try again.");
        return;
    }
