...
const SchoolNameScreen = ({route, navigation}) => {
    return (
...
function handleNextButton(navigation){
    if (!StudentSignupController.getInstance().verifySchoolName(inputText)){
        Alert.alert("School Name", "Please enter your school name");
        return;
    }
    navigation.navigate("GraduationDateScreen");
}
