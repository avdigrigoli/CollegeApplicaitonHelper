    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>first name is...</TitleText>
            </View>
...
function handleNextButton(navigation){
    if (!StudentSignupController.getInstance().verifyName(inputText, NameType.FIRST)){
        Alert.alert("First Name", "Please do not leave your first name blank");
        return;
    }
