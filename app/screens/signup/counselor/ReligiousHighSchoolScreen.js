...
const ReligiousHighSchoolScreen = ({navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>enter if</TitleText>
                <TitleText>your highschool</TitleText>
                <TitleText>is religious or not</TitleText>
            ...
            <View style={{flex: 0.2}}>
                <TextInput 
                    style={styles.input}
                    placeholder="religious affiliated or not religious affiliated"
                    onChangeText={(text) => {
                        inputText = text;
                    }}
                />
...
function handleNextButton(navigation){
    navigation.navigate("PublicHighSchoolScreen");
}
...
export default ReligiousHighSchoolScreen;