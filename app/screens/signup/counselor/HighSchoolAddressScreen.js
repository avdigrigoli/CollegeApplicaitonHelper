...
const HighSchoolAddressScreen = ({navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>address of the</TitleText>
            ...
            <View style={{flex: 0.2}}>
                <TextInput 
                    style={styles.input}
                    placeholder="the address of the highscool"
                    onChangeText={(text) => {
                        inputText = text;
                    }}
                />
...
function handleNextButton(navigation){
    navigation.navigate("NumberOfStudentsHighSchoolScreen");
}
...
export default HighSchoolAddressScreen;