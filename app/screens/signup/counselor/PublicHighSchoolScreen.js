...
const PublicHighSchoolScreen = ({navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>is public or not</TitleText>
            ...
            <View style={{flex: 0.2}}>
                <TextInput 
                    style={styles.input}
                    placeholder="public school or private school"
                    onChangeText={(text) => {
                        inputText = text;
                    }}
                />
...
function handleNextButton(navigation){
    navigation.navigate("BeginJourneyCounselorScreen");
}
...
export default PublicHighSchoolScreen;