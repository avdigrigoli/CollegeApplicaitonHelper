...
const NumberOfStudentsHighSchoolScreen = ({navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText># of students that</TitleText>
                <TitleText>attend the</TitleText>
                <TitleText>highschool</TitleText>
            ...
            <View style={{flex: 0.2}}>
                <TextInput 
                    style={styles.input}
                    placeholder="# of students that attend highscool"
                    onChangeText={(text) => {
                        inputText = text;
                    }}
                />
...
function handleNextButton(navigation){
    navigation.navigate("SchoolsStudentsAreInterestedInScreen");
}
...
export default NumberOfStudentsHighSchoolScreen;