...
const CounselorEmailScreen = ({route, navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={{flex: 0.2}}>
                ...
                />
                <Text style={styles.text}> Please enter your email so you can recover your
                </Text>
...
function handleNextButton(navigation){
    if (!StudentSignupController.getInstance().verifyEmail(inputText)){
        Alert.alert("Email", "Please provide a valid email");
        return;
    }
    navigation.navigate("CounselorPasswordScreen");
}
...
export default CounselorEmailScreen;