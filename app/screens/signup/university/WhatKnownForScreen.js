...
const WhatKnownForScreen = ({navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                <TitleText>What</TitleText>
                <TitleText>are you known for?</TitleText>
            </View>
            ...
            <View style={{flex: 0.2}}>
                ...
                <Text style={styles.text}> This is how your address will appear on Urahah</Text>
            </View>
...
function handleNextButton(navigation){
    navigation.navigate("BeginJourneyUniversityScreen");
}
...
export default WhatKnownForScreen;