...
const ColorSchemeSecondary = ({navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>enter your secondary</TitleText>
                <TitleText>color scheme</TitleText>
            </View>
...
function handleNextButton(navigation){
    navigation.navigate("ColorSchemeAccents");
}
...
export default ColorSchemeSecondary;