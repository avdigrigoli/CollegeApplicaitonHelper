...
const UndergradSizeScreen = ({navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>of undergrads is...</TitleText>
            </View>
            ...
            <View style={{flex: 0.2}}>
                ...
                <Text style={styles.text}> This information will appear public on Urahah</Text>
            </View>
...
function handleNextButton(navigation){
    navigation.navigate("StaffSizeScreen");
}
...
export default UndergradSizeScreen;