    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>five fun</TitleText>
                <TitleText>facts are...</TitleText>
            ...
            <View style={{flex: 0.2}}>
                <TextInput 
                    style={styles.input}
                    placeholder="your five fun facts"
                    onChangeText={(text) => {
                        inputText = text;
                    }}
                />

                <Text style={styles.text}> This information //come back too// Urahah</Text>
            </View>
...
function handleNextButton(navigation){
    navigation.navigate("FiveFunFactsScreen");
}
