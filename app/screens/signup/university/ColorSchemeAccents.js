...
const ColorSchemeAccents = ({navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>accents in</TitleText>
                <TitleText>your color scheme</TitleText>
            </View>
            ...
            <View style={{flex: 0.2}}>
                <TextInput 
                    style={styles.input}
                    placeholder="your color accents"
                    onChangeText={(text) => {
                        inputText = text;
                    }}
                />
...
function handleNextButton(navigation){
    navigation.navigate("MascotScreen");
}
...
export default ColorSchemeAccents;