...
const UniversityProfileScreen = ({navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                <TitleText>This is the profile page</TitleText>
            </View>
...
function handleNextButton(navigation){
    navigation.navigate("UndergradSizeScreen");
}
...
export default UniversityProfileScreen;