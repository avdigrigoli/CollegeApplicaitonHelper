...
const SearchFratScreen = ({route, navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                <TitleText>Please answer</TitleText>
                <TitleText>yes or no if</TitleText>
                <TitleText>you'd prefer to have</TitleText>
                <TitleText>frat life on campus:</TitleText>
            ...
            <View style={{flex: 0.2}}>
                ...
                />
                <Text style={styles.text}> Please choose yes or no whether you'd like to have sorities and fratterities on this cmapus
                </Text>
...
function handleNextButton(navigation){
    navigation.navigate("SearchReligiousScreen");
...
export default SearchFratScreen;