    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>if you'd prefer</TitleText>
                <TitleText>urban / suburban / rural</TitleText>
            ...
            <View style={{flex: 0.2}}>
                <TextInput 
                    style={styles.input}
                    placeholder="City / Suburban / Rural"
                    onChangeText={(text) => {
                        inputText = text;
                    }}
                ...
                />
                <Text style={styles.text}> Please enter the type of city life you desire
                </Text>
