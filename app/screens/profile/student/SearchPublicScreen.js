...
const SearchPublicScreen = ({route, navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>be public or private:</TitleText>
            ...
            <View style={{flex: 0.2}}>
                ...
                />
                <Text style={styles.text}> Please choose if you'd like the university to be public or private
                </Text>
...
export default SearchPublicScreen;