...
const SearchSizeScreen = ({route, navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>the size or #</TitleText>
                <TitleText>of students:</TitleText>
            ...
            <View style={{flex: 0.2}}>
                ...
                />
                <Text style={styles.text}> Please enter the # of students you'd prefer to have at the university
                </Text>
...
function handleNextButton(navigation){
    navigation.navigate("SearchMajorsScreen");
...
export default SearchSizeScreen;