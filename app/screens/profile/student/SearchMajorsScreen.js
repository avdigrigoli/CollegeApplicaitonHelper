...
const SearchMajorsScreen = ({route, navigation}) => {
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.titleView}>
                ...
                <TitleText>the major you'd</TitleText>
            ...
            <View style={{flex: 0.2}}>
                ...
                />
                <Text style={styles.text}> Please enter the major you'd intend to study
                </Text>
...
function handleNextButton(navigation){
    navigation.navigate("SearchMinorsScreen");
...
export default SearchMajorsScreen;